About raven-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/raven-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/getsentry/raven-python

Documentation: https://docs.sentry.io/clients/python/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3501&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/raven-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `raven` can be installed with `conda`:
...
It is possible to list all of the versions of `raven` available on your platform with `conda`:
...
```
mamba search raven --channel conda-forge
```
...
mamba repoquery search raven --channel conda-forge

# List packages depending on `raven`:
mamba repoquery whoneeds raven --channel conda-forge

# List dependencies of `raven`:
mamba repoquery depends raven --channel conda-forge
```
